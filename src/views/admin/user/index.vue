<template>
  <div class="app-container calendar-list-container">
    ...
    >
      ...
      <el-table-column align="center" label="单位主管">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" class-name="status-col" label="单位状态">
        <template slot-scope="scope">
          <el-tag
            :type="scope.row.company_status == 0? 'warning': (scope.row.company_status == 1 ? 'scucess': 'danger')"
    ...
    <el-dialog :title="dialogTitleMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="editForm" :rules="editFormRules" ref="editForm" label-width="100px">
        ...
        <el-form-item label="角色" prop="roleId">
          <el-select class="filter-item" v-model="editForm.roleId" placeholder="请选择角色">
            <el-option
